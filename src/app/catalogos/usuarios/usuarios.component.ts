...
export class UsuariosComponent implements OnInit {
	...
	columns: Array<any> = [
		{title: 'Usuario', name: 'usuario', columnName: 'usuario',
			filtering: {filterString: '', placeholder: 'Filtra usuario'}},
		{title: 'Nombre(s)', name: 'nombre', sort: 'asc', columnName: 'nombre',
			filtering: {filterString: '', placeholder: 'Filtra nombre'}},
		{title: 'Paterno', name: 'paterno', sort: 'asc', columnName: 'paterno',
			filtering: {filterString: '', placeholder: 'Filtra paterno'}},
		{title: 'Materno', name: 'materno', sort: 'asc', columnName: 'materno',
			filtering: {filterString: '', placeholder: 'Filtra materno'}},
