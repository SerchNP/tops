...
@Component({
	selector: 'app-autoriza-riesgos-gestion',
	templateUrl: './autoriza-riesgos-gestion.component.html'
})
export class AutorizaRiesgosGestionComponent implements OnInit, OnDestroy {
	...
	getPendientes() {
		this.subscription = this._riesgo.getRiesgosPendientes('G')
			.subscribe(
				(data: any) => {
	...
	getRechazados() {
		this.subscription = this._riesgo.getRiesgosRechazados('G')
			.subscribe(
				(data: any) => {
