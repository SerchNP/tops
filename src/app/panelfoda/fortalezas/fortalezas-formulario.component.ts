...
@Component({
	selector: 'app-fortalezas-formulario',
	templateUrl: './fortalezas-formulario.component.html',
	styles: []
})
export class FortalezasFormularioComponent implements OnInit {
	...
	constructor(private activatesRoute: ActivatedRoute,
		...
		this.titulo = (this.accion === 'I' ? 'Registro de Fortalezas' : 'Actualización de Fortalezas');
